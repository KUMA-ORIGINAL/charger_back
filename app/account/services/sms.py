...
#
#         status = root.findtext('ns:status' if ns else 'status', namespaces=ns)
#         message_id = root.findtext('ns:id' if ns else 'id', namespaces=ns)
#         phones = root.findtext('ns:phones' if ns else 'phones', namespaces=ns)
#         smscnt = root.findtext('ns:smscnt' if ns else 'smscnt', namespaces=ns)
#
#         return {
#             'status': status,
#             'id': message_id,
